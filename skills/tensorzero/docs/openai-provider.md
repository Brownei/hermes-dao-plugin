# OpenAI-Compatible Provider (e.g. Ollama)
...
The OpenAI model provider supports generating embeddings. You can find a complete code example using Ollama on GitHub.
